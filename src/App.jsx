...
function App() {
    ...
    const levels = [
        ...
        <Level1_dummy key={2} complete={() => complete(2)}/>,
        <Level1_dummy key={3} complete={() => complete(3)}/>,
    ];
            ...
            <nav className="sticky top-0 z-10 border-slate-200 border-b bg-white/80 shadow-sm backdrop-blur-sm">
                <div className="mx-auto max-w-4xl px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <ChevronLeft
                                className="group-hover:-translate-x-1 h-5 w-5 transition-transform group-disabled:group-hover:translate-x-0"/>
                            <span>Previous</span>
                        </button>
                        ...
                        >
                            <span>Next</span>
                            <ChevronRight
                                className="h-5 w-5 transition-transform group-hover:translate-x-1 group-disabled:group-hover:translate-x-0"/>
                        </button>
                    </div>
                </div>
            </nav>
