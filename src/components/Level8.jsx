...
export default function Level8({ complete }) {
  ...
  const progress = Math.round(
    (text.split('').filter((c, i) => i < TARGET.length && c === TARGET[i])
      .length /
      TARGET.length) *
      100,
  );
    ...
    <div className="w-full py-20 text-center">
      ...
      <div className="m-auto mt-4 w-[50%] rounded-xl border border-blue-100 bg-gradient-to-b from-white to-[#fcfeff] p-4">
        ...
        <div className="mb-1 text-base text-gray-800">
          Gdy powiadomienia będą zbyt ciężkie możesz je wyciszyć, jednak
          postaraj się najpierw napisać z włączonymi powiadomieniami, żeby
          zrozumieć z czym mierzą się osoby z zaburzeniami uwagi (np. ADHD).
        </div>
